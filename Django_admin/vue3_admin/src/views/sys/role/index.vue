...
﻿<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="code" label="权限字符" min-width="120" align="center"/>
      <el-table-column prop="data_scope" label="数据权限" min-width="150" align="center">
        <template #default="scope">
          <el-tag v-if="scope.row.data_scope === 1" type="danger">全部数据</el-tag>
          <el-tag v-else-if="scope.row.data_scope === 2" type="warning">本部门及下级部门</el-tag>
          <el-tag v-else-if="scope.row.data_scope === 3" type="success">仅本部门</el-tag>
          <el-tag v-else type="info">仅本人</el-tag>
        </template>
      </el-table-column>
...
<!--      <el-table-column prop="update_time" label="更新时间" width="300" align="center"/>-->
      ...
      <el-table-column prop="action" label="操作" min-width="250" fixed="right" align="center">
